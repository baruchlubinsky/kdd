defmodule KddWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {KddWeb.LayoutView, :root}
  ...
  scope "/", KddWeb do
    ...
    get "/notion", NotionController, :index
    get "/notion/login", NotionController, :login
    get "/notion/auth/callback", NotionController, :callback
